...
export default function (self) {
  ...
  self.setDom = function () {
    if (self.isChildGrid) {
      ...
      // Create animated cell selection overlay as a sibling to the canvas
      if (!self.parentIsCanvas && self.canvas && self.canvas.parentNode) {
        ...
        // Wrap canvas and overlay in a positioned container
        var wrapper = document.createElement('div');
        wrapper.style.cssText = 'position:relative;width:100%;height:100%;';
        self.canvas.parentNode.insertBefore(wrapper, self.canvas);
        wrapper.appendChild(self.canvas);
        wrapper.appendChild(self.selectionOverlay);
      }
