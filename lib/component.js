...
export default function () {
  ...
  component.connectedCallback = function () {
    ...
    // Re-create selection overlay after shadow DOM rebuild
    if (intf.selectionOverlay) {
      intf.selectionOverlay = null;
    }
    if (intf.attributes.animatedCellSelection) {
      intf.selectionOverlay = document.createElement('div');
      intf.selectionOverlay.style.cssText =
        'position:absolute;top:0;left:0;pointer-events:none;box-sizing:border-box;z-index:1;display:none;';
      var wrapper = document.createElement('div');
      wrapper.style.cssText = 'position:relative;width:100%;height:100%;';
      intf.canvas.parentNode.insertBefore(wrapper, intf.canvas);
      wrapper.appendChild(intf.canvas);
      wrapper.appendChild(intf.selectionOverlay);
    }
    intf.connected = true;
